...
states.Start.prototype={
	...
	create: function() {
		...
		var title1 = this.add.bitmapText(this.world.centerX-160, this.world.centerY-160, 'carrier_command','Infinite',42);
		var title2 = this.add.bitmapText(this.world.centerX-100, this.world.centerY-90, 'carrier_command','Space',42);
